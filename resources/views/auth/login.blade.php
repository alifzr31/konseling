...
<head>
    <meta charset="utf-8">
    <title>Enigma Putra Mandiri - Log In</title>
...
<body>
    ...
    <div class="container-fluid page-header py-5 mb-5 wow fadeIn" data-wow-delay="0.1s">
        <div class="container py-5">
            <h1 class="display-3 text-white animated slideInRight">Log In</h1>
                ...
                <div class="col-lg-12 wow fadeInUp" data-wow-delay="0.5s">
                    <form action="{{ route('logstore') }}" method="POST">
                        ...
                        <div class="row g-3">
                            ...
                            <div class="col-12">
                                <center>
                                    <button class="btn btn-primary py-3 px-5 mb-2" type="submit">Log In</button><br/>
                                    You don't have an account?<a href="{{ route('register') }}"> Register here</a>
                                </center>
                            </div>
                        </div>
                    </form>
    ...
    <script>
        ...
        @if(session()->has('success'))
            ...
            toastr.success('{{ session('success') }}', 'Register Successfully!'); 
        @elseif(session()->has('error'))
            toastr.error('{{ session('error') }}', 'Log In Failed'); 
