    <div class="modal modal-video fade" id="sosialModal" tabindex="-1" aria-labelledby="exampleModalLabel"
        aria-hidden="true">
        <div class="modal-dialog">
            <div class="modal-content rounded-0">
                <div class="modal-header">
                    <h3 class="modal-title" id="exampleModalLabel">Konsultasi Kecenderungan Sosial</h3>
                    ...
                    <div class="modal-body" style="padding-left: 10px; padding-right: 10px;">
                        <div class="alert alert-warning mt-2">
                            ...
                            <p class="mb-1" style="text-align: justify;">
                                Anda memilih konsultasi kecenderungan sosial, 
                                dan anda tidak dapat melakukan konsultasi lagi sebelum konsultasi yang anda pilih saat ini selesai. 
                                Apakah anda sudah yakin?
                            </p>
                        </div>
                        <div class="mt-2 mb-4">
                            <a href="{{ route('konsulsosial') }}" class="btn btn-primary px-4 py-3">Yakin</a>
